...
},{"./CollectionView":"src/views/CollectionView.ts","./UserShow":"src/views/UserShow.ts"}],"src/models/Evening.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Collection(rootUrl, deserialize) {
    ...
    this.models = [];
    this.events = new Evening_1.Eventing();
  }
...
},{"./Evening":"src/models/Evening.ts","axios":"node_modules/axios/index.js"}],"src/models/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Evening_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Evening":"src/models/Evening.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/views/UserForm.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  UserForm.prototype.template = function () {
    return "\n        <div>\n        \n        <input placeholder=\"" + this.model.get('name') + "\"/>\n        <button class=\"set-name\">Change name</button>\n        <button class=\"set-age\">Set Round Age</button>\n        <button class=\"save-model\">Save User</button>\n        </div>        \n        ";
  };
...
function (_super) {
  ...
  UserEdit.prototype.onRender = function () {
    ...
    new UserForm_1.UserForm(this.regions.userFrom, this.model).render();
  };
...
var editroot = document.getElementById("root_edit");

if (editroot) {
  var userEdit = new UserEdit_1.UserEdit(editroot, user);
  userEdit.render();
  console.log(userEdit);
} else {
  throw new Error('Root element not found');
}
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
